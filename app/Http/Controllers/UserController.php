    ...
    public function createUser(Request $request)
    {
        try {
            ...
            $user = User::create([
                ...
                // Note: country, state, and city below are legacy / not used as primary location settings.
                // Main address settings use division_id, district_id, upazila_id, area_id, and zone_id.
